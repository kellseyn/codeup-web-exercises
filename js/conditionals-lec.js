...
// var age = confirm("Are you at least 13 years of age or older?");
//
// console.log("Is this person 13 or older? " + age);
//
// if (age){
...
//         return "It's time to slow down!";
//     } else {
//         return "The light is prolly red and it's time to STOP!";
//     }
// }
//
...
// } else {
//     if(userAge === 15){
//         alert("You can have a permit! yey");
//     } else if (userAge >= 16 && hasPermit){
//         alert("you can have a license");
//     } else if (userAge >= 16 && !hasPermit){
//         alert("sorry you need a permit for that");
//     }
// }
...
switch(weather) {
    ...
    case "snow":
        ...
        break;
    default:
        alert(weather + "? sounds bad to me.");
        break;
}
...
switch(trafficLight) {
    case "green":
        ...
        break;
    case "yellow":
        alert("It's time to slow down!");
        break;
    case "red":
        alert("The light is prolly red and it's time to STOP!");
        break;
    default:
        alert(trafficLight + "? What kinda traffic light is that???");
        break;
}
