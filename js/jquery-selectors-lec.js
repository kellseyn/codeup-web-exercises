...
$(document).ready(function() {
	...
	$('#container').css('color', 'rebeccapurple');
	...
	$('ul').css({'list-style-type':'none','display': 'flex', 'justify-content': 'space-between', 'margin-right': '45px'});
	...
	$('#romance-genre, #book-bundle-one').css('background-color', 'pink');
