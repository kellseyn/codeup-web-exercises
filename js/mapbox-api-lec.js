...
geocode("301 Las Colinas Blvd W #268, Irving, Tx, 75039", mapboxToken).then(function (mine) {
    console.log(mine);
    map.setCenter(mine);
    map.setZoom(20);

    var marker = new mapboxgl.Marker(markerOptions)
        .setLngLat([-96.942342, 32.873132])
        .addTo(map);
});
...
reverseGeocode({lng: -96.942342, lat: 32.873132}, mapboxToken).then(function(results) {
    // logs the address for The Alamo
    console.log(results);
});
